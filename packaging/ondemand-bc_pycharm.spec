...
%global repo_name bc_pycharm
%global app_name bc_pycharm
...
License:  MIT
URL:      https://github.com/spinTwo/%{repo_name}
Source0:  https://github.com/spinTwo/%{repo_name}/archive/%{git_tag}.tar.gz
